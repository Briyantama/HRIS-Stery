...
func NewHealthService(pgPool *pgxpool.Pool, redisClient *redis.Client, nc *nats.Conn, logger *zap.Logger) *HealthService {
...
func (h *HealthService) Check(ctx context.Context, req *grpc_health_v1.HealthCheckRequest) (*grpc_health_v1.HealthCheckResponse, error) {
	...
	if h.redisClient != nil && status == grpc_health_v1.HealthCheckResponse_SERVING {
